...
public final class ReadWriteUtils {
    ...
    public static List<CompletableFuture<Integer>> readEvents(ClientFactory client, String rGroup, int numReaders, int limit) {
    ...
    public static List<CompletableFuture<Integer>> readEvents(ClientFactory clientFactory, String readerGroup, int numReaders) {
        return readEvents(clientFactory, readerGroup, numReaders, Integer.MAX_VALUE);
    }

    @SneakyThrows
    public static <T> int readEvents(EventStreamReader<T> reader, int limit) {
    ...
    public static void writeEvents(ClientFactory clientFactory, String streamName, int totalEvents, int offset) {
        @Cleanup
    ...
    public static void writeEvents(ClientFactory clientFactory, String streamName, int totalEvents) {
